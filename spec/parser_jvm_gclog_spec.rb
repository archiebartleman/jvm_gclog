require_relative '../lib/fluent/plugin/parser_jvm_gclog'
require 'spec_helper'
require 'pp'

RSpec.describe Fluent::Plugin::JVMGCLog do
    before :each do
        @jvmgclog = Fluent::Plugin::JVMGCLog.new
      end
